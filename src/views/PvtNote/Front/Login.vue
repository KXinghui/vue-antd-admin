<template>
  <identity-login ms="PVTNOTE" identity-role="user"></identity-login>
</template>

<script>
import IdentityLogin from "../../Base/Front/IdentityLogin";
...
.chat-login-wrap .identity-login {
  margin-top: 3.2rem;
}
